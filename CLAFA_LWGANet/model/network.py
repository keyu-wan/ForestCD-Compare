...
from .backbone.lwganet import LWGANet_L2_1242_e96_k11_RELU, LWGANet_L0_1242_e32_k11_GELU, LWGANet_L1_1242_e64_k11_GELU
...
def get_backbone(backbone_name, dropout_rate):
    ...
    elif backbone_name == 'lwganet_l1': #L1 info is added not originally provided.
        backbone = LWGANet_L1_1242_e64_k11_GELU(pretrained=True, drop_path_rate=dropout_rate)
...
class Detector(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        if self.backbone_name == 'lwganet_l0' or self.backbone_name == 'lwganet_l2' or self.backbone_name == 'lwganet_l1': #L1 is added not originally provided.
